...
import { Scissors, ShoppingBag, Tag, ChevronRight, Star, Palette, Sparkles, Wind } from 'lucide-react'; // Added Palette, Sparkles, Wind
...
const haircutServices: ServiceItem[] = [
  {
    id: 'hc_basic',
  ...
  },
  {
    ...
    icon: <Sparkles className="h-6 w-6 text-primary" /> // Using Sparkles for shaving
  },
  {
    ...
    icon: <Wind className="h-6 w-6 text-primary" /> // Using Wind for massage/wash
  },
  {
    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in-0 duration-500">
      <section className="text-center py-8 bg-card rounded-lg shadow-lg animate-in fade-in-0 delay-100 duration-700">
        ...
        <p className="text-foreground/80 mt-2 max-w-2xl mx-auto">
          {t({ 
            en: 'Explore our range of professional barbering services. All prices are subject to change.', 
            id: 'Jelajahi berbagai layanan barber profesional kami. Semua harga dapat berubah sewaktu-waktu.' 
          })}
        </p>
      </section>
