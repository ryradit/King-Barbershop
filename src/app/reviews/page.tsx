...
import { Send, UserCircle, MessageSquare, Loader2 } from 'lucide-react';
...
export default function LiveCommentsPage() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      setComment(''); 
      // setName(''); // Optionally clear name after successful submission
      toast({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in-0 duration-500">
      ...
      <Card className="bg-card shadow-md animate-in fade-in-0 slide-in-from-bottom-10 delay-200 duration-700 flex flex-col h-[500px]">
        <CardHeader>
